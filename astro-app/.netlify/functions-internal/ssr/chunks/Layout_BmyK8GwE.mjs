...
const $$VimeoEmbed = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$5, $$props, $$slots);
  Astro2.self = $$VimeoEmbed;
  const { node } = Astro2.props;
  const videoId = getVimeoId(node.url);
  const embedUrl = videoId ? getVimeoEmbedUrl(videoId) : null;
  return renderTemplate`${embedUrl && renderTemplate`${maybeRenderHead()}<div class="vimeo-embed"><iframe${addAttribute(embedUrl, "src")}${addAttribute(node.title || "Vimeo video", "title")} allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin" loading="lazy"></iframe></div>`}`;
}, "/Users/chris/Desktop/SERVERS/FAIA/FAIA_DEV/astro-app/src/components/portableText/VimeoEmbed.astro", void 0);
...
const $$ExternalLink = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(href, "href")} target="_blank" rel="noopener noreferrer"> ${renderSlot($$result, $$slots["default"])} </a>`;
}, "/Users/chris/Desktop/SERVERS/FAIA/FAIA_DEV/astro-app/src/components/portableText/ExternalLink.astro", void 0);

const $$Astro$3 = createAstro();
const $$PortableTextContent = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$PortableTextContent;
  const { value, openLinksInNewTab = false } = Astro2.props;
  const components = {
    type: {
      vimeo: $$VimeoEmbed
    },
  ...
  return renderTemplate`${renderComponent($$result, "PortableText", $$PortableText, { "value": value, "components": components })}`;
}, "/Users/chris/Desktop/SERVERS/FAIA/FAIA_DEV/astro-app/src/components/portableText/PortableTextContent.astro", void 0);
...
function getFaviconUrl(settings) {
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const faviconHref = getFaviconUrl(siteSettings) ?? "/favicon.svg";
  const isFaviconSvg = faviconHref === "/favicon.svg";
  return renderTemplate`<html${addAttribute(language, "lang")}> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no"><link rel="icon"${addAttribute(isFaviconSvg ? "image/svg+xml" : "image/png", "type")}${addAttribute(faviconHref, "href")}><link rel="preload" href="/fonts/HelveticaNeue-Medium.woff2" as="font" type="font/woff2" crossorigin><meta name="generator"${addAttribute(Astro2.generator, "content")}><meta name="theme-color" content="cornflowerblue"><title>${title}</title>${renderComponent($$result, "ViewTransitions", $$ViewTransitions, {})}${renderHead()}</head> <body> <div class="container"> ${renderComponent($$result, "Header", $$Header, { "language": language, "pathname": pathname })} <main> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "Footer", $$Footer, {})} </div> </body></html>`;
}, "/Users/chris/Desktop/SERVERS/FAIA/FAIA_DEV/astro-app/src/layouts/Layout.astro", void 0);

export { $$Layout as $, getPosts as a, $$PortableTextContent as b, getLanding as c, getPost as g, urlFor as u };
